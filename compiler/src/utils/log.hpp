...
template <typename... Args> inline void critical(Args &&...args) {
...
#define NOT_IMPLEMENTED()                                                      \
    ::Ceres::Log::panic("Not implemented: {} in {}, line {}",                  \
                        CERES_PRETTY_FUNCTION_NAME, __FILE__, __LINE__)
#define TODO()                                                                 \
    ::Ceres::Log::panic("TODO: Not implemented: {} in {}, line {}",            \
                        CERES_PRETTY_FUNCTION_NAME, __FILE__, __LINE__)
...
#define ASSERT(cond)                                                           \
    do {                                                                       \
        if (!(cond)) {                                                         \
            ::Ceres::Log::panic(                                               \
                "Assertion '{}' failed in {}, line {}, function {}", #cond,    \
