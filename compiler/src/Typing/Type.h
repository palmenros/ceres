...
public:
    ...
    static bool classof(const Type *type) {
        return type->getKind() == TypeKind::UnitVoidType;
    }
...
private:
    static std::unordered_map<std::string, std::unique_ptr<UnresolvedType>>
        instances;
...
private:
    static std::unordered_map<NotYetInferredKind,
                              std::unique_ptr<NotYetInferredType>>
        instances;
...
private:
    static std::unordered_map<PrimitiveKind,
                              std::unique_ptr<PrimitiveScalarType>>
        instances;
