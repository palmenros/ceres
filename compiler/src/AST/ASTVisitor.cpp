...
void ASTVisitor::visitBinaryOperationExpression(
...
void ASTVisitor::visitBoolLiteral(BoolLiteralExpression &lit) {
    visitChildren(lit);
}
...
void ASTVisitor::visitVariableDeclarationStatement(
