...
class ASTStringifierVisitor : public AbstractReturningASTVisitor<std::string> {
    ...
    std::string
    doVisitAssignmentExpression(AssignmentExpression &expr) override;
    std::string
    ...
    std::string
    doVisitIdentifierExpression(IdentifierExpression &expr) override;
    std::string doVisitIfStatement(IfStatement &stm) override;
    std::string
    doVisitIntLiteralExpression(IntLiteralExpression &expr) override;
    ...
    std::string doVisitVariableDeclarationStatement(
