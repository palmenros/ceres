...
public:
    ...
    virtual T
    doVisitBinaryOperationExpression(BinaryOperationExpression &expr) override;
    ...
    virtual T
    doVisitFloatLiteralExpression(FloatLiteralExpression &expr) override;
    virtual T doVisitForStatement(ForStatement &stm) override;
    virtual T
    doVisitFunctionCallExpression(FunctionCallExpression &expr) override;
    ...
    virtual T doVisitVariableDeclarationStatement(
...
template <class T>
T ReturningASTVisitor<T>::doVisitAssignmentExpression(
    AssignmentExpression &expr) {
    return this->visitChildren(expr);
}

template <class T>
T ReturningASTVisitor<T>::doVisitBinaryOperationExpression(
...
template <class T>
T ReturningASTVisitor<T>::doVisitFloatLiteralExpression(
...
template <class T>
T ReturningASTVisitor<T>::doVisitFunctionCallExpression(
...
template <class T>
T ReturningASTVisitor<T>::doVisitIdentifierExpression(
...
template <class T>
T ReturningASTVisitor<T>::doVisitIntLiteralExpression(
...
template <class T>
T ReturningASTVisitor<T>::doVisitVariableDeclaration(
