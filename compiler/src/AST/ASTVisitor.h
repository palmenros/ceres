...
public:
    ...
    virtual void
    visitFloatLiteralExpression(FloatLiteralExpression &expr) override;
    virtual void
    visitFunctionCallExpression(FunctionCallExpression &expr) override;
    ...
    virtual void visitVariableDeclarationStatement(
